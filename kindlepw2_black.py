...
for i, text in enumerate(days):
    ...
    if i == 5 or i == 6:
        ...
        font_symbol = 'en'
    color = grey[3] if (i == 5 or i == 6) else grey[0]
...
for h, row in enumerate(calendar):
    for i, text in enumerate(row):
        ...
        if text in event_days:
            ...
            r = 24  # 半径
            # 在日期下方画一个实心圆
            draw.ellipse((cx - r, cy - r, cx + r, cy + r), fill=grey[12], outline=grey[12])
        ...
        if i == 5 or i == 6:
            ...
            font_symbol = 'en'
        color = grey[3] if (i == 5 or i == 6) or text in holidays else grey[0]
